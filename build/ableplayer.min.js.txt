...
console.log('this.stenoFrameId',this.stenoFrameId);
        this.$stenoFrame = $('#' + this.stenoFrameId);
console.log('this.$stenoFrame (quantity ' + this.$stenoFrame.length + ')', this.$stenoFrame);
...
console.log('stenoMode',this.stenoMode);
console.log('stenoFrameId',this.stenoFrameId);
console.log('$stenoFrame',this.$stenoFrame);
...
console.log('calling initStenoFrame...');

        		thisObj.initStenoFrame().then(function() {

console.log('returned from initStenoFrame()');

              if (thisObj.stenoMode && thisObj.$stenoFrame.length) {
console.log('stenoMode is relevant. Getting iframe contents...');
                thisObj.stenoFrameContents = thisObj.$stenoFrame.contents(); // fuck
console.log('stenoFrameContents:',thisObj.stenoFrameContents);
			        }
			        else {
// TEMP - Delete this loop after testing is complete
console.log('stenoMode is not relevant on this page');
			        }
...
console.log('*** initStenoFrame ***');
console.log('stenoMode',this.stenoMode);
console.log('$stenoFrame',this.$stenoFrame);
console.log('typeof stenoFrame',typeof thisObj.stenoFrame);

    if (this.stenoMode && this.$stenoFrame.length) {

console.log('iframe readyState',this.$stenoFrame[0].readyState);
console.log('iframe contentWindow',this.$stenoFrame[0].contentWindow)
console.log('iframe contentWindow document',this.$stenoFrame[0].contentWindow.document);
console.log('iframe contentWindow document readyState',this.$stenoFrame[0].contentWindow,document.readyState);
...
console.log('no iframe to initialize. Moving on...');
  		deferred.resolve();
		}
		return promise;
	};
...
console.log('onPlayerKeyPress',e.which);
...
console.log('not okToHandleKeyPress');
			return false;
		}
...
console.log('usingModifierKeys is true');
  				e.preventDefault();
					this.handlePlay();
				}
			}
...
console.log('stenoMode',this.stenoMode);
console.log('$stenoFrame',this.$stenoFrame);
console.log('stenoFrame contents',this.stenoFrameContents);

console.log('typeof stenoFrame contents',typeof this.stenoFrameContents);
...
console.log('Listening for iframe keystrokes');
