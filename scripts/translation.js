...
function addTranslationFunctions(AblePlayer) {
	...
	AblePlayer.prototype.getTranslationText = function() {
		...
		if (this.lang) { // a data-lang attribute is included on the media element
			if ( Object.hasOwnProperty( supportedLangs,this.lang ) ) {
				...
				if ( this.lang.indexOf('-') == 2 ) {
					...
					this.lang = ( Object.hasOwnProperty(supportedLangs,this.lang.substring(0,2)) !== -1 ) ? this.lang.substring(0,2) : null;
				} else {
		...
		if (!this.lang) {
			...
			if (docLang) {
				if ( Object.hasOwnProperty( supportedLangs,docLang ) ) {
					...
					if (docLang.indexOf('-') == 2) {
						// this is a localized lang attribute (e.g., fr-CA)
						// try the parent language, given the first two characters
						if ( Object.hasOwnProperty(supportedLangs,docLang.substring(0,2)) ) {
